...
{
    public class PythonSubtractTask : CompetitionTask
    {
        public PythonSubtractTask() : base(
            "Python subtract",
            "Write in Python function body, which takes its parameters, subtracts them and returns a result",
...
print(result)
",
            new[] { new CompetitionTaskTest("12 5", "7") }
            )
        {
